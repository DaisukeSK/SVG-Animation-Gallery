...
Input.oninput=(e)=>{
  // console.log("text width:",outputTXT[0].getBoundingClientRect().width)
  // console.log("svg:",svg)
  // svg.style.width=outputTXT[0].getBoundingClientRect().width+"px"
...
typeButtons.forEach((bttn,key)=>{
  bttn.onclick=()=>{
    ...
    // outputTXT[1].setAttribute("stroke-width","3")

    // outputTXT[0].setAttribute("style","font-weight: 900;font-style: italic;font-family: arial;font-size: 5em;")
    // outputTXT[1].setAttribute("style","font-weight: 900;font-style: italic;font-family: arial;font-size: 5em;")
...
// outputTXT[0].setAttribute("style","font-weight: 900;font-style: italic;font-family: Times New Roman;font-size: 5em;")
//     outputTXT[1].setAttribute("style","font-weight: 900;font-style: italic;font-family: Times New Roman;font-size: 5em;")
